    ...
    return(
        <>
          ...
          <div className="personalDetails">
              ...
              <RadioInput id="male" name="gender" value="male" checked={formData.gender === 'male'} onChange={handleChange}>
                Male
              </RadioInput>

              <RadioInput id="female" name="gender" value="female" checked={formData.gender === 'female'} onChange={handleChange}>
                Female
              </RadioInput>
